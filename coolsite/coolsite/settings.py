...
SECRET_KEY = 'django-insecure-swf_8yp_kxk6u)p_^fa84n&&m5wf@51&%i5ixd=tpb^too=1m='
...
STATICFILES_DIRRS = [] # нестандартных путей у нас нет, поэтому пустой список
...
# Описание констант базы данных каталога 'media'
